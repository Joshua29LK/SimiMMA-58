...
class AppConfigs extends \Simi\Simiconnector\Model\Api\Apiabstract
{
    ...
    public function getAppConfig()
    {
        ...
        $themeConfig = [
            ...
            'button_background_color' => $this->getStoreConfig('themedesign/basic_colors/button_background_color'),
            'button_text_color' => $this->getStoreConfig('themedesign/basic_colors/button_text_color'),
            'menu_background_color' => $this->getStoreConfig('themedesign/basic_colors/menu_background_color'),
            ...
            'search_box_background_color' => $this->getStoreConfig('themedesign/advance_colors/search_box_background_color'),
            'search_text_color' => $this->getStoreConfig('themedesign/advance_colors/search_text_color'),
            'app_background_color' => $this->getStoreConfig('themedesign/advance_colors/app_background_color'),
            ...
            'line_color' => $this->getStoreConfig('themedesign/advance_colors/line_color'),
            ...
            'status_bar_text_color' => $this->getStoreConfig('themedesign/advance_colors/status_bar_text_color'),
